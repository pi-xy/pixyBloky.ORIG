...
Block {
    ...
    property var tiles: {
        ...
        var tile1 = component.createObject(block, {x: 36 * 2, y: 0, color: "#F76500"})
        var tile2 = component.createObject(block, {x: 0, y: 36, color: "#F76500"})
        var tile3 = component.createObject(block, {x: 36, y: 36, color: "#F76500"})
        var tile4 = component.createObject(block, {x: 36 * 2, y: 36, color: "#F76500"})
