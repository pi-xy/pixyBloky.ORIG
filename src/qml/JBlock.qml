...
Block {
    ...
    property var tiles: {
        ...
        var tile1 = component.createObject(block, {x: 0, y: 0, color: "#0376BB"})
        var tile2 = component.createObject(block, {x: 0, y: 36, color: "#0376BB"})
        var tile3 = component.createObject(block, {x: 36, y: 36, color: "#0376BB"})
        var tile4 = component.createObject(block, {x: 36 * 2, y: 36, color: "#0376BB"})
